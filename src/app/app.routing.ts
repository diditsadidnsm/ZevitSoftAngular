...
export const appRoutes: Route[] = [
    ...
    // Admin routes
    {
        ...
        children   : [
            ...
            // Apps
            {path: 'apps', children: [
                {path: 'presale', loadChildren: () => import('app/modules/admin/apps/academy/academy.module').then(m => m.AcademyModule)},
                {path: 'transaction', loadChildren: () => import('app/modules/admin/apps/contacts/contacts.module').then(m => m.ContactsModule)},
                {path: 'help-center', loadChildren: () => import('app/modules/admin/apps/help-center/help-center.module').then(m => m.HelpCenterModule)},
            ]},

            // Pages
            {path: 'pages', children: [
                {path: 'presaleschedule', loadChildren: () => import('app/modules/admin/pages/activities/activities.module').then(m => m.ActivitiesModule)},
